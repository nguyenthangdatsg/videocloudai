# Han2YT_flow — Bulk Image cho Google Flow
...
> 2. Khi chạy, Chrome hiện thanh vàng **"Han2YT_flow đang gỡ lỗi trình duyệt này"** — **để yên, đừng bấm Hủy**.
>
...
4. Bấm **Tải tiện ích đã giải nén** → chọn thư mục `Han2YT_flow`.
...
- Đổi tiêu đề "Han2YT_flow" trong `sidepanel.html` và màu trong `sidepanel.css` (sửa biến `--accent`).
