...
node -e "const [major] = process.versions.node.split('.'); if (parseInt(major) < 20) { console.error('[ERROR] Node.js version 20 or higher is required. Current version is ' + process.version); process.exit(1); }" >nul 2>&1
if errorlevel 1 (
    echo.
    echo ============================================================
